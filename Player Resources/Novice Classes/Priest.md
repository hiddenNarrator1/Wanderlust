...
- **Heart's Aid (1)**: The Priest may instantly stabilize someone who is dying or in critical condition as a 2s Action, and the target is healed of all ill effects. The target heals 1 Grit per round, for a number of rounds equal to the Priest's Power.
- **Hidden in Shadow (2)**: Touch a target to turn them ethereal. Gain the ability to teleport within shadows up to 30 ft as a 2s Action, and add your Power to their Sneak. This lasts a number of rounds equal to the priest's Power.
...
- **Protective Embrace (Passive)**: The Priest always has additional DR equal to their RES.
...
Casting miracles requires the user to make a DC 7 RES roll before casting. Each success increases the next DC by 1. Once the target fails, the spell they are trying to cast is lost until the next rest, and the DC resets. You may also sacrifice 1 Strain to add 1 to the RES roll for this.
