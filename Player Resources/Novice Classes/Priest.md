...
Casting miracles requires the user to make a DC 7 Resolve roll before casting. Each success increases the next DC by 1. Once the target fails, the spell they are trying to cast is lost until the next rest, and the DC resets.
