...
- **Bountiful Life**: Heal an amount of Grit equal to RES + Cast Magic per round over the course of 3 rounds on a target the Priest can see.
...
- **Destructive Blast**: Roll to-hit with the highest combat skill to blast someone with radiant energy at a range of 90 ft. The blast does a number of d8 + Cast Magic in damage equal to half the Priest's level, rounded down (min 1d8). The damage type is chosen between the DM and Priest. The Mana restores after a scene.
